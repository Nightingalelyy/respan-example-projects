#!/usr/bin/env python3
"""Bare-minimum sanity check: OpenInference + run one Pydantic AI agent call."""
...
@workflow(name="pydantic_ai_openinference_hello_world")
def run_agent() -> str:
    agent = Agent(
        model=OPENAI_MODEL,
...
def main() -> None:
    print("=" * 60)
    print("Pydantic AI OpenInference Hello World")
    print("=" * 60)
    ...
    telemetry = RespanTelemetry(
        app_name="pydantic-ai-openinference-hello-world",
        api_key=RESPAN_API_KEY,
        base_url=RESPAN_BASE_URL,
        is_batching_enabled=False,
        # Keep this example on the explicit OpenInference path.
        instruments=set(),
    )
