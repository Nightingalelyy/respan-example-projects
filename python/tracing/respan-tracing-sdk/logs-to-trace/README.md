...
This example demonstrates how to send trace logs to Respan while avoiding ID collisions by processing existing trace data.
...
Learn more about the [Logging API](https://docs.respan.ai/api-endpoints/integration/request-logging-endpoint)
...
4. Sends processed logs to Respan traces endpoint
...
- `RESPAN_BASE_URL`: Respan base URL
